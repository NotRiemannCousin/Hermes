...
namespace Hermes {
    ...
    struct TlsAcceptPolicy {
        ...
        static ConnectionResultOper Listen(Data& data, int backlog) noexcept;
        ...
        static ConnectionResultOper Accept(Data& data, Data& outData) noexcept;
    ...
    private:
        static ConnectionResultOper ServerHandshake(Data& data) noexcept;
    };
